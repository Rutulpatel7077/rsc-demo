...
const db = [
  {
    ...
    title: "A first note which can be a valuable NFT. I know!",
    body: "This is an example note. It contains **Markdown**! It's very easy to make some words **bold** and other words *italic* with Markdown.",
  },
  {
    id: 1,
    created_at: randomDateBetween(startOfThisYear, now),
    updated_at: randomDateBetween(startOfThisYear, now),
    title: "Make a thing with React Server Side Components",
...
![This app is powered by React](https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/React_Native_Logo.png/800px-React_Native_Logo.png)`,
  },
  {
    ...
    created_at: now,
    updated_at: now,
    title: "I wrote this note today. For TechShare",
    body: "It was an excellent note. It's very easy to make some words **bold** and other words *italic* with Markdown.",
  },
];
